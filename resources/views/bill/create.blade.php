...
<body class="px-7 pb-6">
    <form action="{{ route('invoice.store') }}" method="post" id='bill'>
        @csrf
        @method('POST')
        <div class="flex flex-col w-full text-text">
            ...
            <input
                ...
                type="text" id="title" name="title" placeholder="YearBook">
        </div>
        <div class="flex flex-col text-text">
            ...
            <input
                ...
                type="number" id="amount" name="amount" placeholder="150000">
        </div>
